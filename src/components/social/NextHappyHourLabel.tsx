...
function getNextHappyHourLabel() {
  ...
  return `Next Happy Hour: Friday, ${formatted}, lesson ~7:00–7:30 pm · social dancing 7:30–10:00 pm`
}
...
export default function NextHappyHourLabel() {
  ...
  return (
    <p className="mt-3 text-base font-semibold text-white/85 md:text-lg">
      {label ?? "Next Happy Hour: Fridays · lesson ~7:00–7:30 pm · social dancing 7:30–10:00 pm"}
    </p>
  )
}
