...
import { Check, Calendar, Users, Clock, MapPin, ArrowRight, Lock } from "lucide-react";
import { Card, CardContent } from "@/components/ui/card";
import { Badge } from "@/components/ui/badge";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";

export default function CertificationsPage() {
  const scrollToCertificationProcess = () => {
    const element = document.getElementById('certification-process');
  ...
  return (
    <div className="flex flex-col">
        ...
        <div className="container">
          <div className="grid gap-12 md:grid-cols-2 items-center">
            <div className="relative aspect-square max-w-md mx-auto md:mx-0">
              <Image
                src="https://rnlubphxootnmsurnuvr.supabase.co/storage/v1/object/public/assetsv1/Certifications/Certification_Placeholder.png"
            ...
            <div>
              ...
              <Button 
                size="lg" 
                className="mt-8 bg-[#FF3366] text-white hover:bg-[#FF3366]/90"
                onClick={scrollToCertificationProcess}
              >
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 bg-white/80 backdrop-blur-sm z-10 flex flex-col items-center justify-center">
              ...
              <p className="text-gray-600 max-w-md text-center">
                Our certification programs are currently being developed. Join the waitlist to be notified when they launch.
              </p>
            </div>
      ...
      <section className="py-16 md:py-24" id="certification-process">
        <div className="container">
          <div className="mb-12 text-center">
          ...
          <div className="mx-auto max-w-2xl text-center text-white">
            ...
            <div className="mt-8 flex justify-center">
              <Button 
                ...
                onClick={() => window.open('https://forms.gle/SCBxkknTKFr8yGZdA', '_blank')}
              >
                Join the Waitlist
              </Button>
            </div>
