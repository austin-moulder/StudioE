        ...
        <div className="container">
          ...
          <div className="mt-12 flex justify-center">
            <div className="flex items-center gap-2">
              ...
              <Link href="/instructors?page=1" className="flex h-9 min-w-9 items-center justify-center rounded-md border border-[#F94C8D] bg-[#F94C8D] px-3 text-sm text-white hover:bg-[#F94C8D] hover:text-white hover:border-[#F94C8D]">1</Link>
